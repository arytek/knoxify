"""PZ Real World Map Generator — Flask entry point.
...
def generate():
    ...
    raw_name = data.get("mapName") or f"pzmap_{int(time.time())}"
    map_name = SAFE_NAME.sub("_", raw_name).strip("_") or f"pzmap_{int(time.time())}"
...
Generated by PZ Real World Map Generator v2.
